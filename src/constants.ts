export const SITE_TITLE = "Richill Capital Community";
...
export const FOOTER_MENU_GROUPS = [
	{
		title: "What's New",
		items: [
			{
				title: "More content in the Microsoft Store",
				route: "/",
			},
			{
				title: "Apps",
